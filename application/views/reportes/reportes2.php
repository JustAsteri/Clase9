                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="col" style="margin-top: 20px;">
                                            ...
                                            <div class="col-md-12">
                                              <label for="fecha1">Seleccione un Mes (cualquier dia)</label>
                                              <input type="text" class="form-control" id="mes" placeholder="yyyy/mm " id="datepicker-autoclose">
                                        ...
                                        <div class="col-md-12" style="margin: 20px auto;">
                                            <input type="button" value="PDF" name="" id="boton" class="btn btn-primary" onclick="CitasMesCliente();" />
                                        </div>
                                    </div>
                                </div>
                            </div>
